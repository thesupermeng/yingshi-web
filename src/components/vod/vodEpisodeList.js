...
VodEpisodeList = ({
  ...
  return <div className="flex flex-col space-y-4" style={style}>
    ...
    <div className='lg:flex hidden relative'>
      ...
      {showDropdown &&
        <ul className={`flex flex-col overflow-y-scroll max-h-48 ${styles.dropdownContainer} no-scrollbar`}>
    ...
    <ul className="lg:flex hidden flex-column no-scrollbar" style={{ flexWrap: 'wrap', overflowX: 'auto' }}>
