      ...
      <>
        <div className={'desktop'}>
          <div className={'flex flex-col w-[224px] mb-2 cursor-pointer hover:text-shayuBlue'} onClick={onClick}>
            <div className={'h-[126px] rounded-[12px] overflow-hidden relative mb-2'}>
              <Image src={PlaceholderImage} alt={`Image for ${vod.vodname}`} fill={true} objectFit={'cover'}
                     className={'absolute'}/>
        ...
        <div className={'mobile'}>
          <div className={'flex gap-3 my-[12px]'} onClick={onClick}>
            <div className={'h-[87px] w-[154px] rounded-[12px] overflow-hidden relative'}>
              <Image src={PlaceholderImage} alt={`Image for ${vod.vodname}`} fill={true} objectFit={'cover'}
                     className={'absolute'}/>
              <Image src={vod.vodpic} alt={`Image for ${vod.vodname}`} fill={true} objectFit={'cover'}/>
              {/* add placeholder  */}
            ...
            <div className={'flex-1 flex flex-col justify-evenly'}>
              ...
              <span className={'text-[12px]'}>观看至 {secondsToHHMMSS(vod.watchtimes)}</span>
            </div>
          </div>
        </div>
      </>
