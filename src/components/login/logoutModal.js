      ...
      <DialogBody className={'p-0 w-full h-full'}>
        <div className={'flex flex-col gap-[16px] font-medium'}>
          ...
          <div className={'mobile flex gap-2'}>
            <Button className={'flex-1 text-[16px] text-[#9C9C9C] bg-transparent'} size={'sm'} onClick={onCancel} variant={'outlined'}>取消</Button>
            <Button className={'flex-1 text-[16px] text-shayuBlue'} color={'blue'} size={'sm'} onClick={onConfirm} variant={'outlined'}>确定</Button>
          </div>
        </div>
      </DialogBody>
    </Dialog>
