  ...
  return (
    <>
      <div className={'container md:px-12'} style={{ flexDirection: 'column' }}>
        ...
        <div
          className='grid grid-cols-12 mt-6 mb-2'
  ...
  <div className='col-span-12'>
                ...
                <p className='pb-4'>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    1.
                    本《鲨鱼影视隐私协议》（以下称“本隐私协议”）适用于鲨鱼影视的全部产品和服务，包括iOS端应用程序、安卓端应用程序、网页端等全部终端客户端。
                    <br />
                    2.
                    请您在使用鲨鱼影视各项产品和/或服务前，仔细阅读并充分理解本隐私协议的全部内容。一旦您使用或继续使用鲨鱼影视的产品/服务，即表示您同意我们按照本隐私协议使用和处理您的相关信息。
                    <br />
                    3.
                    我们可能会不时依据法律法规或业务调整对本隐私协议进行修订。当本隐私协议发生变更后，我们会在版本更新后通过在显著位置提示或推送通知、消息等形式向您展示变更后的内容。
                    <br />
                    4.
                    您需理解，只有在您确认并同意变更后的《鲨鱼影视隐私协议》，我们才会依据变更后的隐私协议收集、使用、处理和存储您的个人信息；您有权拒绝同意变更后的隐私协议，但请您知悉，一旦您拒绝同意变更后的隐私协议，可能导致您不能或不能继续完整使用鲨鱼影视的相关服务和功能，或者无法达到我们拟达到的服务效果。
                  </span>
                </p>
                <p className='pb-4'>
                  <span style={{ fontSize: '15px', color: '#FFF' }}>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    ...
                    个人信息安全规范》）：是指一旦泄露、非法提供或滥用可能危害人身和财产安全，极易导致个人名誉、身心健康受到损害或歧视性待遇等的个人信息。本隐私协议中涉及的个人敏感信息包括您的个人财产信息、个人身份信息、个人生物识别信息、网络身份标识信息、通讯录信息、精准定位信息、收货地址。我们实际具体收集的个人敏感信息种类以下文描述为准。
                    <br />
                    3.
                    ...
                    ID/IDFA/OpenUDID/GUID/SIM卡IMSI信息等）。唯一设备识别码有多种用途，其中可在不能使用Cookie（例如在移动应用程序中）时用以提供广告。
                    <br />
                    5.
                    IP地址：每台上网的设备都会指定一个编号，称为互联网协议(IP)地址。这些编号通常都是根据地理区域指定的。IP
                    ...
                    <br />
                    8.
                    账号：当您注册账号并向我们提供一些个人信息，您就可以更好的使用我们的服务。当您访问鲨鱼影视时，系统会利用这些账号信息对您进行身份验证，以防止未经授权的人员访问您的账号。
                    <br />
                    9.
                ...
                <p className='pb-4'>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    1.
                    鲨鱼影视依据法律法规以及遵循正当、合法、必要的原则而收集和使用您在使用服务过程中主动提供或由于产品和/或服务需要而产生的个人信息。如果我们欲将您的个人信息用于本隐私协议未载明的其它用途，或基于特定目的将收集而来的信息用于其他目的，我们会及时以合理的方式向您告知，并在使用前再次征得您的同意。
                    <br />
                    2.
                    ...
                    4.1 账号注册
                    <br />
                    （1）您注册并登录鲨鱼影视账号时，需要按照我们的指引完成一系列注册程序，在此过程中，您需要向我们提供以下信息：账号昵称、手机号码（个人敏感信息，用于接受验证码匹配个人身份）。您只有提供真实准确的上述信息，才能成功注册鲨鱼影视账号并使用产品和/或服务的核心功能。如果您选择不提供上述为实现鲨鱼影视核心产品功能的必备信息，或将导致我们无法为您提供该核心产品功能。
                    <br />
                    ...
                    <br />
                    （2）当您使用安卓设备登录我们的产品并使用视频展示和播放时，您可以随时通过使用我们的产品与/或服务的相关功能设置页面开启/取消移动网络信息权限。鲨鱼影视客户端的移动网络信息访问权限设置路径为：“设置—隐私设置-允许鲨鱼影视查看电话信息”。您开启该权限即视为您授权我们可以访问、获取、收集、使用您的该等个人信息；但当您取消该授权后，我们将不再收集该信息，也无法再为您提供上述与之对应的服务；但除非您依照法律的规定删除了您的个人信息，否则您的取消行为不会影响我们基于您之前的授权进行的您个人信息的处理、存储。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。
                    <br />
                    （3）请您理解，您只有提供上述信息才能使用鲨鱼影视产品和/或服务的核心功能，如果您选择不提供上述为实现鲨鱼影视核心产品功能的必备信息，或将导致我们无法为您提供该核心产品功能。
                    <br />
                    4.4 客户服务
                    <br />
                    ...
                    4.6 视频拍摄
                    <br />
                    （1）当您使用设备相机拍摄视频时，我们将访问您的设备相机相关权限，并收集您提供的基于拍摄视频后向我们上传的视频信息。如您拒绝提供该权限和内容的，仅会使您无法使用该功能，但并不影响您正常使用产品与/或服务的其他功能。同时，您也可以随时通过您的设备系统或使用我们的产品与/或服务的相关功能设置页面开启/取消该权限。鲨鱼影视客户端的相机权限设置路径为：“设置—隐私设置—允许鲨鱼影视使用相机功能”。
                    <br />
                    ...
                    4.7 微博分享和投稿发布
                    <br />
                    当您使用iOS设备登录我们的产品并在使用微博分享和投稿发布功能时，我们将访问您的位置权限，并收集您提供的基于使用微博分享和投稿发布后向我们上传的位置信息。同时，您也可以随时通过您的设备系统开启/取消该权限。iOS端鲨鱼影视
                    APP的位置权限可以通过系统关闭，路径为：“设置-&gt;鲨鱼影视-&gt;位置”。您开启该权限即视为您授权我们可以访问、获取、收集、使用您的该等个人信息；当您取消该授权后，我们将不再收集该信息，也无法再为您提供上述与之对应的服务；但除非您依照法律的规定删除了您的个人信息，否则您的取消行为不会影响我们基于您之前的授权进行的对您个人信息的处理、存储。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。
                    <br />
                    4.8 定向推荐、维护/改进我们的产品与/或服务之必需
                    <br />
                    （1）我们会基于收集的信息，对您的偏好、习惯等作特征分析和用户画像，以便为您提供更适合的定制化服务，例如向您展现或推荐相关程度更高（而非普遍推送）的搜索结果、视频内容、信息流或者广告/推广信息结果。为此，我们需要收集（包括在后台状态下收集）您的信息，包括您的设备信息（硬件型号、设备MAC地址、IMEI、IDFA、IMSI、必要的软件列表）、浏览器型号、日志信息、浏览记录、点赞/分享/评论/互动的对象、搜索的字词、年龄、性别。同时，为保障您接收信息的自主性，当您对我们推送的个性化内容不感兴趣或希望减少某些信息推荐时，您可以在鲨鱼影视客户端内通过长按视频并选择“不感兴趣”，进行精准屏蔽。当您更新APP版本后，未经您的明确同意，我们不会更改您之前设置的权限状态。
                    <br />
                ...
                <p className='pb-4'>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    ...
                    <br />
                    1.3
                    在法律要求或允许的范围内，为了保护用户或社会公众的利益、财产或安全免遭损害而有必要提供您的个人信息给第三方；
                    <br />
                    1.4
                    您的个人信息可能会在我们的关联公司之间共享。我们只会共享必要的个人信息，且这种共享亦受本隐私协议声明目的的约束。关联公司如要改变个人信息的处理目的，将再次征求您的授权同意；
                    <br />
                    1.5
                    为了向您提供更完善、优质的产品和服务，我们的某些服务将由授权合作伙伴提供。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。同时，我们会与合作伙伴签署严格的保密协定，要求他们按照我们的说明、本隐私协议以及其他任何相关的保密和安全措施来处理您的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。如果您拒绝我们的合作伙伴在提供服务时收集为提供服务所必须的个人信息，将可能导致您无法在我们的平台中使用该第三方服务。通常我们的合作伙伴有如下几类（现在及未来）：
                    <br />
                ...
                <p className='pb-4'>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    ...
                    <br />
                    1.2
                    存储期限：我们在为您提供满足产品和服务目的所必需且最短的期间内保留您的个人信息，例如：当您使用我们的注册及会员功能时，我们需要收集您的手机号码，且在您提供后并在您使用该功能期间，我们需要持续保存您的手机号码，以向您正常提供该功能、保障您的账号和系统安全。此外，我们或对您的相关信息保存至相关法律所规定的必要期限。
                    <br />
                    1.3
                    ...
                    <br />
                    2.2
                    我们使用符合业界标准的安全防护措施保护您提供的个人信息，防止数据遭到未经授权的访问、公开披露、使用、修改，防止数据发生损坏或丢失。我们会采取一切合理可行的措施，保护您的个人信息。例如使用SSL对数据进行加密保护；我们已建立访问控制机制，确保只有授权人员才可以访问个人信息；我们不时的举办安全和隐私保护培训课程，加强员工对于保护个人信息重要性的认识。
                    <br />
                    2.3
                    为防止安全事故的发生，我们成立了专门的数据安全部门并制定了妥善的预警机制和应急预案。一旦发生个人信息安全事件，我们将按照法律法规的要求，及时向您告知：安全事件的基本情况和可能的影响、我们已采取或将要采取的处置措施、您可自主防范和降低风险的建议和对您的补救措施，并立即启动应急预案，力求将损失最小化。我们将及时将事件相关情况以电话、推送通知等方式告知您。
                  </span>
                </p>
                <p className='pb-4'>
                  <span style={{ fontSize: '15px', color: '#FFF' }}>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    ...
                    <br />
                    1.2
                    使用信息：您可以通过相关产品页面随时查阅您的使用信息，包括：投稿内容、关注、评论、点赞、收藏记录等；
                    <br />
                    1.3
                    其他信息：如您在访问过程中遇到操作问题需获取其他前述无法获知的个人信息内容，您可通过本隐私协议提供的方式联系我们。
                    <br />
                    2. 您有权更正/修改您的个人信息
                    <br />
                    ...
                    <br />
                    2.1
                    对于您的部分个人信息，我们在产品的相关功能页面为您提供了操作设置，您可以直接进行更正/修改，例如：“头像/昵称/性别/出生年月/个人签名”在鲨鱼影视iOS客户端中的更正/修改路径为：点击头像-编辑资料。
                    <br />
                    2.2
                    ...
                    <br />
                    3.
                    1对于您的部分个人信息，您也可以自行通过我们提供的相关产品和服务的功能页面，主动删除您提供信息。例如：您可以自主删除您发布的视频，一旦您删除后，我们即会对此类信息进行删除或匿名化处理，除非法律法规另有规定。
                    <br />
                    3.
                    2当发生以下情况时，您可以直接要求我们删除您的个人信息，但已做匿名化处理或法律法规另有规定的除外：
                    <br />
                ...
                <p className='pb-4'>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    1.
                    未成年人使用我们的产品与/或服务前应取得其监护人的同意。如您为未成年人，在使用我们的产品与/或服务前，应在监护人监护、指导下共同阅读本隐私协议且应在监护人明确同意和指导下使用我们的产品与/或服务、提交个人信息。我们根据国家相关法律法规的规定保护未成年人的个人信息，只会在法律法规允许、监护人明确同意或保护您的权益所必要的情况下收集、使用或公开披露未成年人的个人信息。
                    <br />
                    2.
                    若您是未成年人的监护人，当您对您所监护的未成年人的个人信息有相关疑问时，您可以通过本隐私协议第十一条“联系我们”中公示的联系方式与我们沟通解决。如果我们发现在未事先获得可证实的监护人同意的情况下收集了未成年人的个人信息，则会尽快删除相关数据。
                  </span>
                </p>
                <p className='pb-4'>
                  <span style={{ fontSize: '15px', color: '#FFF' }}>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    1.
                    鲨鱼影视将从2021年11月1日起，根据《个人信息保护法》的相关规定升级死者个人信息保护制度。鲨鱼影视用户（仅限自然人）去世后，其近亲属为了自身的合法、正当利益，可以通过本隐私协议第十一条“联系我们”中公示的联系方式，对去世用户的相关个人信息行使查阅、复制、更正、删除等权利，但是去世用户生前另有安排的除外。
                    <br />
                    2.
                    您理解并确认，为了充分保护去世用户的个人信息权益，申请行使本条权利的去世用户近亲属需要根据鲨鱼影视的指定流程或客服提示，提交去世用户的身份证明文件、死亡证明文件、申请人的身份证明文件、申请人与去世用户的亲属关系证明文件，并提供申请行使的权利种类、目的。更多关于去世用户的个人信息保护流程、条件等事项请详见《帮助中心》。
                  </span>
                </p>
                <p className='pb-4'>
                  <span style={{ fontSize: '15px', color: '#FFF' }}>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    1.
                    如您对本《鲨鱼影视隐私协议》的内容或使用我们的服务时遇到的与隐私保护相关的事宜有任何疑问或进行咨询或投诉时，您均可以通过如下任一方式与我们取得联系：
                    <br />
                    1.1
                    ...
                    <br />
                    2.
                    我们会在收到您的意见及建议后，并在验证您的用户身份后的15个工作日内向您回复。此外，您理解并知悉，在与个人信息有关的如下情形下，我们将无法回复您的请求：
                    <br />
                    2.1 与国家安全、国防安全有关的；
                    <br />
                ...
                <p className='pb-4'>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    1.
                    为了给您提供更好的服务，我们会根据产品的更新情况及法律法规的相关要求更新本隐私协议的条款，该等更新构成本隐私协议的一部分。未经您明确同意，我们不会削减您按照本政策所应享有的权利。我们将在更新后的本隐私协议生效前通过在显著位置提示或向您发送推送消息或以其他方式通知您，如该等更新造成您在本隐私协议下权利的实质减少或重大变更，我们会再次征求您的明示同意。
                    <br />
                    2. 重大变更包括但不限于：
                    <br />
                    2.1
                ...
                <p className='pb-4'>
                  ...
                  <span style={{ fontSize: '13px', color: '#FFF' }}>
                    ...
                    <br />
                    2.
                    本隐私协议的标题仅为方便及阅读而设，并不影响正文其中任何规定的含义或解释。
                  </span>
                </p>
              </div>
        </div>
